...
namespace Alkambia.App.LoanMonitoring.Helper.Converter
{
    public class MoneyConverter
    {
        public static string ConvertDoubleToMoney(double money)
        {
            string moneyValue = String.Format("{0:C}", money);
            return moneyValue;
        }

        public static string ConvertDoubleToMoneyWord(double money)
        {
            string input = money.ToString();
